...
export type GetAppPlansQuery = { __typename?: 'Query', getAppPlans: Array<{ __typename?: 'PlanGraphql', name: string, key: string, description?: string | null, trialDays?: number | null, prices: Array<{ __typename?: 'PriceGraphql', recurrenceInterval: string, amount: number, currency: string, key: string }> }> };
